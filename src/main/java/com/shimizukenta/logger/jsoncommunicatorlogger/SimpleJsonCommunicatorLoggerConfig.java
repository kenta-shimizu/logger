...
public class SimpleJsonCommunicatorLoggerConfig extends AbstractJsonCommunicatorLoggerConfig {
	
	private static final long serialVersionUID = -911171190254295917L;
	
	private static final String DEFAULT_SIMPLE_PATH_PREFIX = "log_";
	private static final String DEFAULT_SIMPLE_PATH_SUFFIX = ".log";
	private static final DateTimeFormatter DEFAULT_SIMPLE_TIMESTAMP_FORMAT = DateTimeFormatter.ofPattern("uuuuMMddHHmmssSS");
	...
	public SimpleJsonCommunicatorLoggerConfig() {
		super();
